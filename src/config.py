...
# Shop Coordinates (Absolute 1920x1080)
POS_SHOP_MAX = (1840, 964)
POS_SHOP_PURCHASE = (1634, 1034)

# Inventory / Sell Coordinates
POS_INV_TAB_HOLD = (100, 380)
POS_INV_QUICK_SELL = (1026, 975)
POS_INV_CONFIRM = (1160, 720)
